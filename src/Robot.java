...
public class Robot {
	...
	//Estos metodos van a tener que actualizar la posicion de la caja que reciban y ver como
	...
	public boolean moverRobCajaDestino(int[] caja, int[] destino, int[][] cajasTemp, int[][] destinosTemp,
		...
		while (caja[0]!=destino[0] && caja[1]!=destino[1]) {
			 ...
			 * habitacion) == '#' || getX()>caja[0] && mirarArriba(cajasTemp, destinosTemp,
			 * habitacion) == '!' || getX()>caja[0] && mirarArriba(cajasTemp, destinosTemp,
			 * habitacion) == '-') {
			 * 
			 * if(mirarArriba(cajasTemp, destinosTemp, habitacion) == '#') {
			 * 
			 * } }
			 * 
